...
export class OptionsComponent implements OnInit {
  ...
  loadMockOptions(): void {
    ...
    this.options = [
      { optionsId: 1, ask: 100, bid: 90, change: 5, contractSymbol: 'ABC', impliedVolatility: 0.2, lastRefresh: 20052001, openInterest: 1000, optionType: 'call', price: 105, settlementDate: 20240410, stockListing: 'XYZ', strikePrice: 95, volume: 500 },
      { optionsId: 2, ask: 110, bid: 100, change: 8, contractSymbol: 'DEF', impliedVolatility: 0.25, lastRefresh: 20052001, openInterest: 800, optionType: 'put', price: 112, settlementDate: 20240515, stockListing: 'UVW', strikePrice: 105, volume: 700 },
  ...
  loadOptions(optionType: string): void {
    ...
    // Apply date filter
    this.displayedOptions = this.filterByDate(filteredOptions);
  }
